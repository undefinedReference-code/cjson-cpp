...
unsigned parse_hex4_impl(const unsigned char * const input)
{
    ...
    auto hex_digit_to_int = [](unsigned char c) -> unsigned int {
    ...
    {
        /* parse digit */
        unsigned int val = hex_digit_to_int(input[i]);
        if (val == 0xFF)
        {
            return 0; 
        }
...
static unsigned char utf16_literal_to_utf8(const unsigned char * const input_pointer, const unsigned char * const input_end, unsigned char **output_pointer)
{
    ...
    first_code = parse_hex4_impl(first_sequence + 2);
    ...
    if ((first_code >= 0xD800) && (first_code <= 0xDBFF))
    {
        ...
        second_code = parse_hex4_impl(second_sequence + 2);
        /* check that the code is valid */
